...
设计灵感参考了 [Everything Claude Code](https://github.com/affaan-m/everything-claude-code)（Anthropic 黑客松获奖项目），在其自动化和安全体系基础上融入实战经验：闭环验证、规则沉淀、文档园丁、先策略后执行、渐进式按需加载、文档权威分级治理。
